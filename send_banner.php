...
if($_POST && isset($_FILES['upload_fonts']))
{
    ...
    $width_banner = $_POST['width-banner'];
    $height_banner = $_POST['height-banner'];
...
$mail->Body    = 'E-mail заказчика: '.$sender_email.'<br>Выбран формат: '.$format.'<br>Выбрана рекламная площадка: '.$advertising.'<br>Желаемая ширина: '.$width_banner.'<br>Желаемая высота: '.$height_banner.'';
