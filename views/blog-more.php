...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="blog-more-img">
                    <img src="../img/blog-more1pic.png" alt="" class="bigimg">
                </div>

                <div class="data-of-release d-flex">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>
                    5 вещей, о которых нужно помнить перед началом маркетинговой кампании
                </h1>
                ...
                <div class="blog-more-img pic2">
                        <img src="../img/blog-more2pic.png" alt="" class="bigimg">
                </div>
                ...
                <p>
                    Чем четче вы определите свою целевую аудиторию, тем более убедительным станет ваше предложение, тем более реалистичными будут ваши цели, а продажи будут более успешными.продаете, что нужно клиенту, и чем руководствуются клиенты при покупках. Да и вообще, полезно расписать, каких результатов вы пытаетесь
                </p>

                <h2>
                    2. Опишите вашего типичного покупателя
                </h2>

                <div class="blog-more-img pic3">
                        <img src="../img/blog-more3pic.png" alt="" class="bigimg">
                </div>
                ...
                <div class="author d-flex">
                    <img src="../img/author-icon.png" alt="author">
                    <p>
                        Автор: <span class="color-text"> Kusionowicz </span>
                    </p>
                </div>
            </div>
        </div>
